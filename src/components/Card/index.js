...
// Handle more description
  ...
  {isMoreDescription? textValue='Show less': textValue='Show more'}
...
// handle more taxonmy
 ...
 let textTaxonomyValue = "+ 5 more"
 {isMoreTaxonomy? textTaxonomyValue="Show less":textTaxonomyValue="+ 5 more"}


//Handle more Property
  ...
  let textPropertyValue = "+ 7 more"
  {isMoreProprties? textPropertyValue="Show less":textPropertyValue="+7 more"}
...
<div className="CardContainer">
  <div className="internalContainer">
      ...
      <span >
          ...
          <a href="#" style={{paddingLeft:'8px'}} onClick={moreTaxonomy}>{textTaxonomyValue}</a>
          </span>
      ...
      <span style={{paddingLeft:'8px'}}>
            ...
            <a style={{paddingLeft:'8px'}} href="#" onClick={MoreProprties}>{textPropertyValue}</a>
